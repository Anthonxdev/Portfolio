...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'projects.als.desc'         : 'National job portal in the Dominican Republic connecting candidates with companies',
      'projects.eoe.desc'         : 'Online platform to learn and practice spoken English',
      'projects.lomasserenas.desc': 'Real estate site for affordable beachfront condos in Sosúa, Puerto Plata',
      'projects.estancia.desc'    : 'Vacation apartment rentals in Puerto Plata, built on WordPress',
      'projects.royalsaturn.desc' : 'Luxury real estate & investment platform — currently under construction',
    ...
    es: {
      ...
      'projects.als.desc'         : 'Portal nacional de empleos en República Dominicana que conecta candidatos con empresas',
      'projects.eoe.desc'         : 'Plataforma online para aprender y practicar inglés hablado',
      'projects.lomasserenas.desc': 'Sitio inmobiliario de condominios frente al mar en Sosúa, Puerto Plata',
      'projects.estancia.desc'    : 'Alquiler de apartamentos vacacionales en Puerto Plata, creado con WordPress',
      'projects.royalsaturn.desc' : 'Plataforma de bienes raíces de lujo e inversión — actualmente en construcción',
